...
export default {
	...
	methods: {
		...
		pickerChange(e) {
			...
			changePickerValue.splice(0,1,18)//替换
			...
			console.log(898,this.pickerValue)
		...
		_getLabel() {
			...
			return pcikerLabel; */
			let pcikerLabel =
				'广东省' + '-' + this.cityDataList[this.pickerValue[1]].label + '-' + this.areaDataList[this.pickerValue[2]].label;
			return pcikerLabel;
		},
		_getCityCode() {
		...
		queryIndex(params = [], type = 'value') {
			...
			return {
				...
				data: {
					//province: provinceData[provinceIndex],(默认写死广东0)
