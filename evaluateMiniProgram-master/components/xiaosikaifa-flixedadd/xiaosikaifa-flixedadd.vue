	...
	<view>
		...
		<view v-if="xiaosikaifa_add_list_flag" :animation="animationaddlist" class="xiaosikaifa_add_list">
			...
			<view v-for="(listvalue, index) in addlistdata" :key="index" class="xiaosikaifa_add_list_item" @tap="addlisttap(index)">
				...
				<button open-type="contact" class="online-contact-button" v-if="listvalue.type == 1">
				   <image :src="listvalue.src" class="online-contact-image" mode="aspectFit"></image>
				</button>
				<button class="online-contact-button" v-if="listvalue.type == 2">
				   <image :src="listvalue.src" class="online-contact-image" mode="aspectFit" ></image>
				</button>
			</view>
