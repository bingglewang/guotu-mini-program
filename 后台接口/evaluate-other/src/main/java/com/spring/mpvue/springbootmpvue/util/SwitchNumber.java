...
public class SwitchNumber {
   ...
   /* public static void main(String[] args) {
        ...
        list.add(1999);
        list.add(2001);
        Integer[] listArray = new Integer[list.size()];//当泛型为Integer时，需要
        listArray =  (Integer[])list.toArray(listArray);
        int zhongshu = majorityElement(listArray);
        System.out.println("众数:"+zhongshu);
